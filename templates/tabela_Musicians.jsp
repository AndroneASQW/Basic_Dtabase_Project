      ...
      <div class="row">
        <div class="col-md-12">
          <ul class="breadcrumb" style="margin-bottom: 0px; margin-top: 0px;">
            ...
            <li class="breadcrumb-item active">Tabela Musicians</li>
          </ul>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            <input id="birth_name"  type="text" class="form-control form-control-lg" placeholder="Birth Name"> </div>
          <div class="form-group">
            <input id="alias" type="text" class="form-control form-control-lg" placeholder="Alias"> </div>
          <div class="form-group">
            <input id="year" type="text" class="form-control form-control-lg" placeholder="Birth Date"> </div>
          <div class="form-group">
            <input id="genre" type="text" class="form-control form-control-lg" placeholder="Genre"> </div>
          <div class="form-group">
            <input id="band" type="text" class="form-control form-control-lg" placeholder="Band"> </div>
          <div class="form-group">
            <input id="profile_url" type="text" class="form-control form-control-lg" placeholder="Profile URL"> </div>
          <div class="form-group">
            <input id="intrument" type="text" class="form-control form-control-lg" placeholder="Instrument">
            <div class="row">
              <div class="col-md-4">
                <div class="col-md-6">
